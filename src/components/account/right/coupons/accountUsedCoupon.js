...
export default class AccountUsedCoupon extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        };
    ...
    render() {
        ...
        let item = list && list.map((cur, index, arr) => {
            return <div className="clear account-stale-coupon-main-item" style={{background:'linear-gradient(90deg, #ECECEB 0%, #909090 100%)'}} key={index.toString()}>
